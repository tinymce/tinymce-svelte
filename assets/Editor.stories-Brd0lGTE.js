...
</div>`.trim();let ve=Jn;const ke=dn({excludePlugins:["tinydrive","uploadcare"]}),ze={channel:"8"},Kn={title:"Editor",component:ie,args:{...ze,apiKey:Xn,inline:!1}},{Story:we}=Pn();var Qn=j('<div style="padding-top:100px; height:400px; border:1px solid #ccciq"><!></div>'),Zn=j("<!> <!>",1);function Be(e,t){W(t,!1),Et();var i=Zn(),n=E(i);{const a=(r,l=fe)=>{ie(r,te(l,{get value(){return ve},get config(){return ke}}))};let s=ft(()=>({...ze,inline:!1}));we(n,{name:"Iframe",get args(){return m(s)},template:a,$$slots:{template:!0},parameters:{__svelteCsf:{rawCode:"<Editor {...args} {value} config={ fullConfig }/>"}}})}var o=se(n,2);we(o,{name:"Inline",args:{inline:!0},template:(s,r=fe)=>{var l=Qn(),p=Te(l);ie(p,te(r,{get value(){return ve},get config(){return ke}})),h(s,l)},$$slots:{template:!0},parameters:{__svelteCsf:{rawCode:`<div style="padding-top:100px; height:400px; border:1px solid #ccciq">
  <Editor {...args} {value} config={ fullConfig }/>
